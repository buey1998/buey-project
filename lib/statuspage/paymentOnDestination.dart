...
class PaymentOnDestination extends StatefulWidget {
  PaymentOnDestination({Key key}) : super(key: key);

  @override
  _PaymentOnDestinationState createState() => _PaymentOnDestinationState();
}

class _PaymentOnDestinationState extends State<PaymentOnDestination> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('myorder')
            .where('status', isEqualTo: 'เก็บเงินปลายทาง')
            .snapshots(),
            ...
            return GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              DetailsOrder(orderdata: orderdata, docs: docs)));
                });
          }).toList());
        });
  }
