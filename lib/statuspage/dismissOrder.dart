...
class DismissOrder extends StatefulWidget {
  DismissOrder({Key key}) : super(key: key);

  @override
  _DismissOrderState createState() => _DismissOrderState();
}

class _DismissOrderState extends State<DismissOrder> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('myorder')
            .where('status', isEqualTo: 'ยกเลิก')
            .snapshots(),
