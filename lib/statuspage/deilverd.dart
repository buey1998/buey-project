...
class Deilvered extends StatefulWidget {
  Deilvered({Key key}) : super(key: key);

  @override
  _DeilveredState createState() => _DeilveredState();
}

class _DeilveredState extends State<Deilvered> {
  @override
